<?php
    ...
    $query = "
        ...
        FROM (
            ...
            GROUP BY 
                s.id
            HAVING
                general_avg > 75  -- Filter students with general average greater than 75
        ) AS students_above_75
    ";
    ...
    try {
        ...
        $students_above_75 = $result['students_above_75'];
