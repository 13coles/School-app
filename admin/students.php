                    ...
                    <div class="modal-content">
                        <form id="attendanceForm">
                                    ...
                                    <div class="col-md-10">
                                        <div class="form-group">
                                            ...
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="presentRadio" name="attendance" class="custom-control-input" value="present">
                                                <label class="custom-control-label text-success" for="presentRadio">
                                                    <i class="fas fa-check-circle mr-1"></i>Present
                                                </label>
                                            </div>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="absentRadio" name="attendance" class="custom-control-input" value="absent">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="submit" class="btn btn-primary" id="saveAttendance">
