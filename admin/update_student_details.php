<?php
    ...
    function fetchStudentDetails($student_id) {
        ...
        try {
            ...
            # break the full name into 3, full name, last name and middle name separated by comma
    ...
    try {
        ...
        # if get request, return the get function (selecting user to edit)
        if ($_SERVER['REQUEST_METHOD'] === 'GET') {
          ...
          # if post request, return the post function (update)
            ...
            # Combine names if separate fields are provided client side full name combination failed
